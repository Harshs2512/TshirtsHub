...
const SearchStore = () => {
    ...
    // filter by cat
    const handleFilter = (value, id, catName) => {
        let all = [...checked];
        ...
        <Layout title={"DefaultStore"}>
            ...
            <div className="flex py-36">
                ...
                {loading ? ( // Render loading indicator when loading is true
                    <div className="flex ml-[40rem] mt-40 h-screen">
                        <Spin size="large" />
                    </div>
                ) : (
                                ...
                                {products && products.map((p) => (
                                    <div
                                        ...
                                        <Link to={`/product/${p.slug}`}>
                                            <div className="rounded-full absolute w-10 h-10 p-2 bg-gray-200/50 ml-48 mt-3 hover:bg-white duration-200 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
                                                <UilHeartAlt />
                                            </div>
                                            <img
                                                className=""
